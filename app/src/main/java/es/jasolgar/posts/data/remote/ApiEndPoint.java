...
class ApiEndPoint {
    public static final String ENDPOINT_POST = "https://jsonplaceholder.typicode.com/posts";

    public static final String ENDPOINT_USERS = "https://jsonplaceholder.typicode.com/users";
